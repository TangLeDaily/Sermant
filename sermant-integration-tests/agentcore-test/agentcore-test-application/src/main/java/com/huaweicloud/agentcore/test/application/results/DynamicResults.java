...
public enum DynamicResults {
     ...
     * 动态卸载插件，拦截点失效
     */
    DYNAMIC_UNINSTALL_INTERCEPTOR_FAIL("Test dynamic uninstall plugin interceptor fail."),
     ...
     * 动态卸载AGENT，插件失效
     */
    DYNAMIC_UNINSTALL_AGENT_INTERCEPTOR_FAIL("Test dynamic uninstall agent that interceptor fail."),
    /**
     * 在此安装AGENT，插件生效
     */
    DYNAMIC_REINSTALL_AGENT_INTERCEPTOR_SUCCESS("Test dynamic reinstall agent that interceptor success.");
