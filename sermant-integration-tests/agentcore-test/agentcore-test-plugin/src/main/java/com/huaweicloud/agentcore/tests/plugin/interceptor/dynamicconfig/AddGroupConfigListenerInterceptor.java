...
public class AddGroupConfigListenerInterceptor extends BaseInterceptor {
    ...
    public ExecuteContext before(ExecuteContext context) {
        ...
        context.getArguments()[PARAM_INDEX_0] = dynamicConfigService.doAddGroupListener(group,
        ...
        LOGGER.log(Level.INFO, "[Agentcore-test-plugin]: AddGroupConfigListener, group:{0}, result:{1}",
