...
public class RemoveConfigListenerInterceptor extends BaseInterceptor {
    ...
    public ExecuteContext before(ExecuteContext context) {
        ...
        context.getArguments()[PARAM_INDEX_0] = dynamicConfigService.doRemoveConfigListener(key, group);
        LOGGER.log(Level.INFO, "[Agentcore-test-plugin]: RemoveConfigListener, key:{0}, group:{1}, result:{2}",
